...
def write_dosage(input, output):
	...
	try:
		...
		# merge using PLINK
		plink_cmd = "/home/mlibydt3/galaxy/tools/bin/plink --noweb --allow-no-sex --fam %s --dosage %s list format=1 sepheader --write-dosage --out %s --silent" % (fam_file, dosage_list, output)
		os.system(plink_cmd)
